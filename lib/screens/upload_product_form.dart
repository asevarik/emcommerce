...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  String _brandValue;
  AlertDialogCustom _globalMethods = AlertDialogCustom();
    ...
    if (isValid) {
      ...
      try {
        if (_pickedImage == null) {
          _globalMethods.showDialogg('Error', 'Please Pick An image', context);
        } else {
          setState(() {
            _isLoading = true;
          });
          ...
          await FirebaseFirestore.instance
            ...
            'userId': _uid,
            'Color': (math.Random().nextDouble() * 0xFFFFFF).toInt().toString(),
        ...
        _globalMethods.showDialogg("Error", error.message, context);
